...
func TestProcessRawEventLetsOrdinaryContentReachPlanner(t *testing.T) {
	t.Skip("TODO: Rewrite - old ThoughtCandidate system removed")
// 	t.Skip("TODO: Rewrite test - old ThoughtCandidate system removed, Candidate field is now interface{}")
// 	ctx := context.Background()
// 	cfg := config.Default()
// 	cfg.QQ.SelfID = 123456
// 	db := testsupport.NewDB(t)
...
func TestProcessCandidateCompletesAfterDeliberationError(t *testing.T) {
	t.Skip("TODO: Rewrite - EnqueueCandidate/ClaimDue removed")
// 	t.Skip("TODO: Rewrite test - EnqueueCandidate/ClaimDue methods removed, ThoughtCandidate system removed")
// 	ctx := context.Background()
// 	working := group_actor.NewManager(ingress.NewMemoryEventLog())
// 	defer working.Close()
// 
...
func TestProactiveCandidateRequiresIdleAndTopic(t *testing.T) {
	t.Skip("TODO: Rewrite - proactiveCandidate returns interface{}")
// 	t.Skip("TODO: Rewrite test - proactiveCandidate returns interface{}, old ThoughtCandidate system removed")
// 	ctx := context.Background()
// 	eventLog := ingress.NewMemoryEventLog()
// 	working := group_actor.NewManager(eventLog)
// 	defer working.Close()
